...
[ExecuteInEditMode] 
public class GodFX_Mirror : MonoBehaviour
{
    ...
    private void CreateMirrorObjects( Camera currentCamera, out Camera reflectionCamera )
    {
        ...
        if( !reflectionCamera ) 
        {
            GameObject go = new GameObject( "GodFX_Mirror Refl Camera id" + GetInstanceID() + " for " + currentCamera.GetInstanceID(), typeof(Camera), typeof(Skybox) );
